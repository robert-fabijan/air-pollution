...
class DataprocSparkJob:
    ...
    def _create_cluster_operator(self):
        """
        Create a spark cluster based on inserted configuration. Cluster will install all
        necessary dependencies for pyspark to run a job
        """
    ...
    def _delete_cluster_operator(self):
        """
        After successfull job run delete cluster to save costs and resources
        """
